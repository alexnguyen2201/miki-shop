...
CREATE TABLE "mt_product_warranty" (
  "id" bigserial PRIMARY KEY,
  "product_id" bigint NOT NULL,
...
COMMENT ON COLUMN "mt_product_file"."purpose" IS 'image for descriptions, image for thumnail';
...
ALTER TABLE "mt_product_warranty" ADD FOREIGN KEY ("product_id") REFERENCES "products" ("id");

ALTER TABLE "mt_product_warranty" ADD FOREIGN KEY ("warranty_id") REFERENCES "warranties" ("id");

ALTER TABLE "mt_product_file" ADD FOREIGN KEY ("product_id") REFERENCES "products" ("id");

ALTER TABLE "mt_product_file" ADD FOREIGN KEY ("file_id") REFERENCES "files" ("id");
